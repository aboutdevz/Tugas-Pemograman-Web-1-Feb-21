...
<div class="row d-flex justify-content-center align-items-center">
  <div class="col-12 col-md-8 bg-white rounded pl-5 pr-5 pb-5">
    <h1 class="text-center pt-4 pb-5">Input Data Pelajaran</h1>

    <form class="form-horizontal" action="<?=base_url('Pelajaran/insertPelajaran')?>" method="post">

      <div class="form-group row">
        <label for="mata_pelajaran" class="col-sm-2 col-form-label"> <b>Mata Pelajaran</b> </label>
        <div class="col-sm-10">
          <input type="text" class="form-control " placeholder="Insert Mata Pelajaran" name="mata_pelajaran" required>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <select class="form-control" placeholder="select Kelas" maxlenght="3" name="kelas" required>
            <option>X</option>
            <option>XI</option>
            <option>XII</option>
          </select>
